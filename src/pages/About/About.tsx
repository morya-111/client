		...
		<div>
			<div className="min-h-screen overflow-x-hidden bg-light">
				<div className="relative w-full h-[600px] 2xl:h-screen ">
					...
					<div className="text-[13px] sm:hidden m-1 mt-96 pt-10 text-center">
						<b className="text-semiDark">BookEx</b> is a community
						made to connect readers and encourage them to
						<br />{" "}
						<b className="opacity-75 text-semiDark">
							Read Everyday
						</b>{" "}
