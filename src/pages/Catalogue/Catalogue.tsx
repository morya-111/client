	...
	return (
		<>
			<div className="min-h-screen overflow-hidden">
				<div
					className={
						openSidebar ? "max-h-screen overflow-hidden" : ""
					}
				>
					<NavigationBar />
					...
					<div className="relative w-full min-h-screen bg-bgGrey45">
						<div className="sticky top-0 ">
							...
							>
								...
								<div className="absolute h-full w-[42%]">
									<Search />
								</div>
							</div>
					...
					<Sidebar />
						...
						<div className="flex flex-col col-span-full col-start-1 mt-[40px] px-2 md:px-14 noneed">
							...
							{isLoading || isFetching || isRefetching ? (
								...
								<>
									<div className="grid gap-5 mx-8 my-4 sm:m-4 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-8 xl:grid-cols-12 noneed ">
										{(
											data?.data.data.books as Array<any>
										).map((book, idx) => (
											<Card
												onClick={() =>
													history.push(
